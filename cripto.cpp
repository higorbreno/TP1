...
#include <cstdlib> // Inclusão da biblioteca necessária para usar a função "rand()"
...
unsigned long long Codificar(unsigned int bit32) {
	unsigned int posicao1 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	unsigned int posicao2 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	unsigned int posicao3 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	unsigned int posicao4 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	unsigned int posicao5 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	unsigned int posicao6 = rand() % 32; // Escolhe uma número pseudoaleatório entre 0 e 31
	...
	bit64 += posicoes; // Guarda as posições junto com o número modificado
